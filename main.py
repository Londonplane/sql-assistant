...
def main():
    ...
    conversation_history.append({"role": "system", "content": "Answer user questions by generating SQL queries against the Chinook Music Database."})
    print("system: Answer user questions by generating SQL queries against the Chinook Music Database.")
    ...
    while True:
        ...
        pretty_print_conversation(conversation_history[-2:])  # Pass only the last two messages (assistant and function results)
